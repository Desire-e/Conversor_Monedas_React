...
import CoinProvider from './components/CoinProvider';


/**
 * NOTA: cuidado con hacer MUCHAS peticiones, la clave es de prueba gratuita 
 * y tiene un límite mensual. La que hay actualmente está prácticamente sin usar.  
 */
            ...
            <div className="col-md-6">
                ...
                <div className="card shadow rounded-4">
                    <div className="card-body">
                        <h3 className="text-center mb-4">Conversor de monedas</h3>
